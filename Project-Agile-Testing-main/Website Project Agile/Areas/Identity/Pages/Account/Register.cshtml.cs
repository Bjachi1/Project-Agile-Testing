...
namespace Website_Project_Agile.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "Het {0} moet minstens {2} en maximum {1} karakters lang zijn.", MinimumLength = 4)]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Bevestig uw email!",
                        $"Bevestig uw email adres door <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>HIER</a> te klikken.");
